function(input, output, session) {
  ...
  onclick("use_gps",{
    ...
    output$sum_table <- renderDT({
        ...
        n=length(unique(dset$PT_TERM[which(dset$INAME==input$intro_drug)]))
    ...
    output$top_subs <- renderPlotly({
        ...
        aes = dset[which(dset$PT_TERM == input$intro_ae), c('INAME', 'PT_COUNT', 'PRR')] %>% distinct();
    ...
    output$dload2 <- downloadHandler(
        ...
        content = function(file){
            if(input$downloadType6 == ".csv") {
                write.csv(dset[which(dset$PT_TERM == input$intro_ae), c('INAME', 'PT_COUNT', 'PRR')], file, row.names = FALSE)
            } else if(input$downloadType6 == ".json") {
                exportJSON <- toJSON(dset[which(dset$PT_TERM == input$intro_ae), c('INAME', 'PT_COUNT', 'PRR')])
                write(exportJSON, file)
            } else if(input$downloadType6 == ".xlsx") {
                write_xlsx(dset[which(dset$PT_TERM == input$intro_ae), c('INAME', 'PT_COUNT', 'PRR')], path=file)
            } else if(input$downloadType6 == ".txt") {
                write.table(dset[which(dset$PT_TERM == input$intro_ae), c('INAME', 'PT_COUNT', 'PRR')], file, row.names=FALSE)
            }
        }
    ...
    observeEvent(input$popdt2, ignoreInit=T, {
        aes = dset[which(dset$PT_TERM == input$intro_ae), c('INAME', 'PT_COUNT', 'PRR')]
        if(nrow(aes)==0){
            showNotification("Not enough data available", type="warning")
        }
        shiny::validate(
    ...
    observeEvent(event_data("plotly_click", source = "P"), {
        ...
        if(pieData$key=="<1") tableDat = dset[which(dset$PT_TERM == input$intro_ae & dset$PRR<1), c('INAME', 'PT_COUNT', 'PRR')]
        else if(pieData$key=="1-5") tableDat = dset[which(dset$PT_TERM == input$intro_ae & dset$PRR>=1 & dset$PRR<5), c('INAME', 'PT_COUNT', 'PRR')]
        else if(pieData$key=="5-10") tableDat = dset[which(dset$PT_TERM == input$intro_ae & dset$PRR>=5 & dset$PRR<10), c('INAME', 'PT_COUNT', 'PRR')]
        else if(pieData$key=="10-100") tableDat = dset[which(dset$PT_TERM == input$intro_ae & dset$PRR>=10 & dset$PRR<100), c('INAME', 'PT_COUNT', 'PRR')]
        else if(pieData$key==">100") tableDat = dset[which(dset$PT_TERM == input$intro_ae & dset$PRR>=100), c('INAME', 'PT_COUNT', 'PRR')]
   ...
   observeEvent(input$mult_ae_file, {
    ...
    output$drugperc <- renderDataTable(
        data.frame("PRR"=round(unique(dset[which(dset$INAME==input$cc_2 & dset$PRR>=quantile(class_dat_global()$PRR, input$pcentile_input/100)),])$PRR, 2), 
                   "LOG_10"=round(unique(dset[which(dset$INAME==input$cc_2 & dset$PRR>=quantile(class_dat_global()$PRR, input$pcentile_input/100)),])$L10_PRR, 2), 
                   "SUBS."=paste0(unique(dset[which(dset$INAME==input$cc_2 & dset$PRR>=quantile(class_dat_global()$PRR, input$pcentile_input/100)),])$PT_COUNT, "/", unique(dset[which(dset$INAME==input$cc_2 & dset$PRR>=quantile(class_dat_global()$PRR, input$pcentile_input/100)),])$CASE_COUNT, " (", round(as.numeric(unique(dset[which(dset$INAME==input$cc_2 & dset$PRR>=quantile(class_dat_global()$PRR, input$pcentile_input/100)),])$PT_COUNT)/as.numeric(unique(dset[which(dset$INAME==input$cc_2 & dset$PRR>=quantile(class_dat_global()$PRR, input$pcentile_input/100)),])$CASE_COUNT), digits=3), ")"), 
                   "ADVERSE_EVENT"=unique(dset$PT_TERM[which(dset$INAME==input$cc_2 & dset$PRR>=quantile(class_dat_global()$PRR, input$pcentile_input/100))])),
    ...
    output$drugperc21 <- renderDataTable(
        data.frame("PRR"=round(unique(dset[which(dset$INAME==input$cc_2 & dset$PRR>=quantile(class_dat_global()$PRR, input$pcentile_input21/100)),])$PRR, 2), 
                   "LOG_10"=round(unique(dset[which(dset$INAME==input$cc_2 & dset$PRR>=quantile(class_dat_global()$PRR, input$pcentile_input21/100)),])$L10_PRR, 2), 
                   "SUBS."=paste0(unique(dset[which(dset$INAME==input$cc_2 & dset$PRR>=quantile(class_dat_global()$PRR, input$pcentile_input21/100)),])$PT_COUNT, "/", unique(dset[which(dset$INAME==input$cc_2 & dset$PRR>=quantile(class_dat_global()$PRR, input$pcentile_input21/100)),])$CASE_COUNT, " (", round(as.numeric(unique(dset[which(dset$INAME==input$cc_2 & dset$PRR>=quantile(class_dat_global()$PRR, input$pcentile_input21/100)),])$PT_COUNT)/as.numeric(unique(dset[which(dset$INAME==input$cc_2 & dset$PRR>=quantile(class_dat_global()$PRR, input$pcentile_input21/100)),])$CASE_COUNT), digits=3), ")"), 
                   "ADVERSE_EVENT"=unique(dset$PT_TERM[which(dset$INAME==input$cc_2 & dset$PRR>=quantile(class_dat_global()$PRR, input$pcentile_input21/100))])),
        rownames=FALSE, selection="single", class="compact")
    ...
    output$drugperc22 <- renderDataTable(
        data.frame("PRR"=round(unique(dset[which(dset$INAME==input$cc_2 & dset$PRR>=quantile(class_dat_global()$PRR, input$pcentile_input22/100)),])$PRR, 2), 
                   "LOG_10"=round(unique(dset[which(dset$INAME==input$cc_2 & dset$PRR>=quantile(class_dat_global()$PRR, input$pcentile_input22/100)),])$L10_PRR, 2), 
                   "SUBS."=paste0(unique(dset[which(dset$INAME==input$cc_2 & dset$PRR>=quantile(class_dat_global()$PRR, input$pcentile_input22/100)),])$PT_COUNT, "/", unique(dset[which(dset$INAME==input$cc_2 & dset$PRR>=quantile(class_dat_global()$PRR, input$pcentile_input22/100)),])$CASE_COUNT, " (", round(as.numeric(unique(dset[which(dset$INAME==input$cc_2 & dset$PRR>=quantile(class_dat_global()$PRR, input$pcentile_input22/100)),])$PT_COUNT)/as.numeric(unique(dset[which(dset$INAME==input$cc_2 & dset$PRR>=quantile(class_dat_global()$PRR, input$pcentile_input22/100)),])$CASE_COUNT), digits=3), ")"), 
                   "ADVERSE_EVENT"=unique(dset$PT_TERM[which(dset$INAME==input$cc_2 & dset$PRR>=quantile(class_dat_global()$PRR, input$pcentile_input22/100))])),
        rownames=FALSE, selection="single", class="compact")
