function(input, output, session) {
  ...
  observeEvent(event_data("plotly_click", source = "E"), {
    ...
    showModal(modalDialog(
      ...
      div(style="float:right", selectInput("downloadType5", label=NULL, choices=c("CSV"=".csv", "TXT"=".txt", "JSON"=".json"), selected=".csv", width=80)),
  ...
  observeEvent(event_data("plotly_click", source = "P"), {
    ...
    showModal(modalDialog(
      ...
      div(style="float:right", selectInput("downloadType7", label=NULL, choices=c("CSV"=".csv", "TXT"=".txt", "JSON"=".json"), selected=".csv", width=80)),
      ...
      tabsetPanel(type = "tabs",
                  tabPanel("Data Table", div(style="float:right", downloadButton("download_6", "Download")),
                           div(style="float:right", selectInput("downloadType6", label=NULL, 
                                                                choices=c("CSV"=".csv", "TXT"=".txt", "JSON"=".json"), selected=".csv", width=80)),
  ...
  observeEvent(input$compae_file, {
    ...
    dat=c()
    if(tolower(tools::file_ext(infile$datapath)) == "txt"){
      tryCatch(
        {
